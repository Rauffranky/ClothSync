...
const AdminTutorDashboardStats = () => {
    const location = useLocation();
    const isParentPage = location.pathname === "/admin/parents";
    ...
    const filteredStats = isParentPage
        ? stats.filter(s => s.label !== "Suspended")
        : stats;

    const gridCols = isParentPage
...
export default AdminTutorDashboardStats;
