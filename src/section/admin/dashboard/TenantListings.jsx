    ...
    return (
        <div className="flex flex-col gap-4">
            ...
            {isDashboard ? ( // Conditional render
                <h5 className='font-medium mt-4'>Tenant Listings</h5>
            ) : (
                    ...
                    rowActions={(row) => (
                        <div className="flex items-center gap-1 justify-center">
                            <Button
                                ...
                                onClick={() => navigate(`/admin/tenant/${row.id}`)}
                            />
                            {row.status !== "Blocked" && (
                                <>
                                    <Button
            ...
            <ApproveModal
                ...
                onApprove={() => console.log("Approved", selectedTenant?.name)}
            ...
            <SuspendModal
                ...
                onSuspend={(reason) => console.log("Suspended", selectedTenant?.name, reason)}
            />

            <BlockModal
                isOpen={isBlockOpen}
                onClose={() => setIsBlockOpen(false)}
                onBlock={(reason) => console.log("Blocked", selectedTenant?.name, reason)}
            />
        </div>
    );
};
