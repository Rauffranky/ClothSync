...
const TopTenants = () => {
  // Render function for each tenant card
  const renderTenantCard = (tenant) => (
    ...
    >
      ...
      {/* Subject */}
      <p className="text-text text-sm mb-3">{tenant.subject}</p>
  ...
  return (
    <div className="md:pb-30 md:pt-60 md:-mt-22.5 py-12 px-6 relative overflow-hidden">
      ...
      />
      <img
        src="/landing-images/top-tenant-bg.svg"
        alt=""
      ...
      <div className="max-w-7xl mx-auto text-center mb-16 relative z-1">
        ...
        <h1 className="font-bold text-gray-900 mb-12">Top Tenants by Reviews</h1>
      </div>

      <div className="lg:px-10 px-2 mx-auto relative z-1">
        <Slider
          items={tenants}
          renderSlide={renderTenantCard}
          showNavigation={true}
          showPagination={true}
