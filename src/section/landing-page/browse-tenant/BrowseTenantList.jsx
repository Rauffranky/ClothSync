...
const TenantCard = ({ tenant, isFavorite, onToggleFavorite }) => {
      ...
      <div className="flex flex-col lg:flex-row gap-6">
        ...
        <div className="flex-1 space-y-3">
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2">
            <div>
              <h3 className="text-xl font-bold text-[#1E1E1E]">{tenant.name}</h3>
          ...
          <div className="flex flex-wrap items-center gap-y-2 gap-x-6 text-[#1E1E1E] text-[15px] font-medium">
            ...
            <div className="flex items-center gap-2">
              ...
              <span>{tenant.studentsTenanted}</span>
            </div>
          </div>
        ...
        <div className="flex flex-col justify-between items-center sm:items-end gap-4 min-w-35 mb-2 lg:mb-0 ">
          {/* Top Tenant Badge & Favorite (moved to end of card) */}
...
const BrowseTenantList = ({ showFavoritesOnly = false }) => {
  ...
  const filteredTenants = showFavoritesOnly
    ? tenants.filter((tenant) => favorites.includes(tenant.id))
    : tenants;
    ...
    <div className="space-y-6">
      {filteredTenants.length > 0 ? (
        ...
        <div className="text-center py-10 text-gray-500">
          No {showFavoritesOnly ? "favorite" : ""} tenants found.
        </div>
      )}
...
export default BrowseTenantList;
