            ...
            <div className="flex items-center justify-between gap-4">
                ...
                <div className="flex items-center gap-2 overflow-hidden flex-1 justify-center">
                    {media.map((item, i) => (
                        <div
                            key={i}
                            className={`w-14 h-16 rounded-xl border-2 overflow-hidden cursor-pointer transition-all shrink-0 relative ${activeIndex === i ? "border-[#2E7D32] scale-105 z-10" : "border-translaundry opacity-60 hover:opacity-100"
                                }`}
