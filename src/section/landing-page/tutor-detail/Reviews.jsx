...
const ReviewCard = ({ review }) => {
  ...
  const isReviewPage = location.pathname === "/tutor/review-page";
  const isParentReviewsPage = location.pathname === "/parents/reviews";
  ...
  return (
    <>
      ...
      >
        {/* Header: Tutor being reviewed & Parent Info */}
        {!isReviewPage && (
          <div className="space-y-3">
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
              <div className="flex items-center gap-3">
                <img
                  src={review.tutorImage}
                  alt=""
            ...
            {isParentReviewsPage && review.reply && (
