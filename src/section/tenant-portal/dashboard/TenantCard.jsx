    ...
    if (!tenant) {
        return (
            <CardOutline className="p-6 bg-white border-gray-100" rounded="rounded-[24px]" shadow="shadow-sm">
                <div className="text-center text-gray-500">Tenant information not available</div>
            </CardOutline>
        );
    }
            ...
            >
                        ...
                        <div className="flex justify-between w-full lg:flex-col gap-2  ">
                            <div className="flex justify-end items-center gap-3">
                                ...
                                <button
                                    ...
                                    onClick={() => onToggleFavorite && onToggleFavorite(tenant.id)}
                                >
                                    <Heart
                                        size={20}
                ...
                <div className="flex justify-between items-center flex-wrap gap-2 ">
                    ...
                    <div className="flex flex-wrap gap-3 w-full justify-end mt-2 sm:mt-0">
                        {location.pathname === "/laundries/my-tenant" && (
                            <>
                                <Button
                                    variant="white"
                                    label="Write Review"
