...
import WriteReviewModal from "../../../tenant-portal/dashboard/WriteReviewModal";

const PastLessonsDetail = () => {
    ...
    return (
        <div className="bg-white rounded-[20px]">
            <div className="flex items-center justify-between">
                <h4 className="font-bold my-4">Lesson Details</h4>
...
export default PastLessonsDetail;
