...
const RaiseDisputeModal = ({ isOpen, onClose, lessonId, tenantName = "Alex" }) => {
    ...
    const disputeOptions = [
        { value: "late", label: "Tenant was late" },
        { value: "absent", label: "Tenant was absent" },
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div className="space-y-1.5">
                        ...
                        <GlobalInput
                            ...
                            onChange={(val) => handleChange("tenant", val)}
                            disabled
