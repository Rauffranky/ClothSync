...
const UpcomingLessonsDetails = () => {
    ...
    const [data] = useState([
        {
            ...
            lessonTime: "Starting in 20h 10mins",
            isStartingSoon: true,
        },
        {
            id: 2,
    ...
    const columns = [
        ...
        },
        {
            ...
            align: "center",
            render: (value, row) => (
                <span className={row.isStartingSoon ? "text-green-500 font-medium" : ""}>
                    {value}
                </span>
            ),
        },
    ...
    return (
        <div className="bg-white rounded-[20px]">
            <div className="flex items-center justify-between">
                <h4 className="font-bold my-4">Lesson Detail</h4>
...
export default UpcomingLessonsDetails;
