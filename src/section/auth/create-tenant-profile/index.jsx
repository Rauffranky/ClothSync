...
const CreateTenantProfileSection = () => {
  ...
  const handleOpenAiModal = (field) => {
    ...
    setAiGeneratedText(
      "I am a dedicated and professional tenant with a strong passion for helping students learn and grow. I focus on clear explanations, practical examples, and personalized guidance to ensure every student understands the subject with confidence",
    ); // Mock AI text
  ...
  return (
    <div className="w-full flex flex-col items-center">
      <h2 className="mb-6 font-medium text-center">Create Tenant Profile</h2>
...
export default CreateTenantProfileSection;
