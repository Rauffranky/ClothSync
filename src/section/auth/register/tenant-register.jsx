...
const TenantRegisterSection = ({ role = "tenant" }) => {
    ...
    <>
      <div className="w-full px-0 md:px-12">
        <h2 className="mb-3 font-medium! text-center">
          {role === "laundry" ? "Create Laundry Account" : "Create Tenant Account"}
        </h2>
        ...
        >
          ...
          <div className="text-center mt-4">
            ...
            >
              ...
              {role === "laundry"
                ? "Change to Tenant Registration"
                : "Change to Laundry Registration"}
            </button>
          </div>
        </form>
      </div>
...
export default TenantRegisterSection;
