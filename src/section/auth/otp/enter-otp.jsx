  ...
  return (
    <>
      <div className="flex flex-col items-center text-center mt-6">
        <>
          <h2 className="mb-3 font-medium! text-center">Verification</h2>
        ...
        <div className="flex gap-3 justify-center mb-6">
          {otp.map((data, index) => {
            return (
              <input
                className="w-10 md:w-24 md:h-16 h-10 text-center text-xl font-bold bg-[#EDEDED] border-2 border-border-2 dark:bg-[#2a313d] dark:border-[#465064] rounded-lg focus:outline-none focus:ring-1 focus:ring-border-3"
                type="text"
                name="otp"
                maxLength="1"
                key={index}
        ...
        <h6 className=" mb-6">
          We've sent a verification code to {email || ".......alex@gmail.com"}
        </h6>

        <div className="text-center mb-16">
          <h6 className="">
            If you don't receive the code within a minute, click Resend button
            below.
          </h6>
          <button
        ...
        <div className="w-full max-w-62.5">
          <Button
            ...
            onClick={() => {
              navigate(`/auth/new-password?role=${role}`);
            }}
          />
        </div>
      </div>
